...
\begin{description}
    ...
    \item[python image libraries] deze zijn vanuit de Delft Computer Graphics group beschikbaar gesteld. De groep heeft nog geen kennis van deze libraries. Mogelijk gebruikte image libraries zijn VTK\cite{vtk}, ITK\cite{itk}, en numpy\cite{numpy}.
