...
In dit hoofdstuk wordt verteld wat de algemene planning van het project is. De verschillende fases worden aangegeven, evenals de deadlines die voor die fases gelden.
...
\begin{description}
	...
	\item[Dr. Kleinrensink] CASAM-projectleider
\end{description}
