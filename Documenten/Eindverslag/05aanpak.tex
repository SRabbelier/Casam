...
Voor de interface hebben we ervoor gekozen om veel gebruik te maken van JavaScript en zijn bibliotheken. Dit gaf ons eenvoudige toegang tot diverse visuele effecten, zoals drag en drop, fade en de sliders. Daarnaast konden we met behulp van JavaScript gebruik maken van de AJaX techniek, waarmee we server requests konden sturen, en de pagina konden updaten zonder dat de gebruiker hier last van had.
