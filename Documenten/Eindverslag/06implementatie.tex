...
\begin{description}
  ...
  De Pati\"{e}nt die echter aan een OriginalImage hing, is verwijdert uit de geplande databaseopzet omdat dit niets toevoegde aan het systeem.
...
De overlay wordt opgeslagen in de database en is beschikbaar voor weergave vanuit de interface (zie Figuur \ref{fig:screen2}).
