...
\subsection{Verschillende doorzichtige foto's over elkaar heen leggen om de verschillen te bekijken}
...
\subsection{Herkenningspunten bij de afbeeldingen}
...
\subsection{Afbeeldingen tekenen over foto's om belangrijke gebieden aan te geven, ook wel bitmaps genoemd}
...
\subsection{Toevoegen van relevante papers en websites}
...
\subsection{Tags toevoegen aan projecten om ze te categoriseren}
...
\subsection{Afstanden meten in foto's}
...
\subsection{Tekenen: de serverkant}
