...
\section{Bestandstypen van foto's} %7.1
...
\section{Verschillende kleuren in flash applicatie} %7.2
...
\section{Opslaan van een lege bitmap} %7.3
...
\section{Te grote foto's inladen in de flash-applicatie} %7.4
...
\section{Statistische data bij landmarks} %7.5
...
\section{Uitwerken afstand meet applicatie} %7.6
\label{customjaap}
...
\section{Uitgebreid user management en arts-view mode} %7.7
...
\section{Verwijderen measurements zonder admin}
...
\section{Image Processing verbeteringen}
...
\section{Zoom op meerdere niveau's}
...
\section{Schaalweergave in image}
...
\section{Export on unix, import on windows}
...
\section{HTML en JavaScript refactor}
