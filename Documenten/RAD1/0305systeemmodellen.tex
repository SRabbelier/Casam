...
\item   Naam: Add Image \\
	...
	Flow of events
	\begin{enumerate}
        \item Anton heeft een account als onderzoeker op het systeem en wil een foto toevoegen. Hij start hiertoe de applicatie op.
...
\item  Naam: View Images  \\
	...
	Flow of events
	\begin{enumerate}
		\item De actor wil een specifiek aantal plaatjes bekijken van een project.
		\item Hij selecteert het project en klikt op de thumbnails.
		\item Nu krijgt hij alle images te zien voor dat project met aan de rechterkant een sidebar.
		\item In deze sidebar kan hij aangeven welke plaatjes hij wil zien en met welke metingen
	\end{enumerate}
\end{enumerate}
...
\item   Naam: Add Measurement from existing type  \\
	...
	Flow of events
	\begin{enumerate}
		\item Anton wil een nieuwe meting toevoegen aan een foto.
		\item Hij selecteert het project en klikt erop.
		\item Hierna klikt hij op de foto waarvan hij de meting wil toevoegen of voegt hij een nieuwe foto toe.
		\item Hij sleept hierna de gewenste measurement naar de image op de goede locatie.
		\item Als de measurement goed staat bevestigd hij de positie.
	\end{enumerate}
\end{enumerate}
...
\item   Naam: Add new Measurement type  \\
	...
	\begin{enumerate}
		...
		\item Hierna voert hij het type meting in (punt, piecewise linear length, area).
...
\item   Naam: Add User  \\
	...
	\begin{enumerate}
	  \item De beheerder wil een nieuwe gebruiker toevoegen.
		...
		\item Het password en de username wordt getoond
	\end{enumerate}
\end{enumerate}
