...
class PointDistributionModel:
  ...
  # Skip the reading of data for now, might as well get it directly from the database
  ...
  #Also some PCA
  filterPCA.SetNumberOfInputs(2)
  filterPCA.SetInput(0,GPAGrid)
  filterPCA.SetInput(1,GPAGrid2)
  print "Performing Principal Component Analysis..."
  filterPCA.Update()
  print "Done!"
  PCAGrid = filterPCA.GetOutput(0)
  PCAGrid2 = filterPCA.GetOutput(1)
  
    #Create a mapper for our data
  aVertexMapperPCA = vtk.vtkDataSetMapper()
  aVertexMapperPCA.SetInput(PCAGrid)
  #Create the actor
  aVertexActorPCA = vtk.vtkActor()
  aVertexActorPCA.SetMapper(aVertexMapperPCA)
  aVertexActorPCA.GetProperty().SetDiffuseColor(1, 1, 0)
  
  #Create a mapper for our data
  aVertexMapperPCA2 = vtk.vtkDataSetMapper()
  aVertexMapperPCA2.SetInput(PCAGrid2)
  #Create the actor
  aVertexActorPCA2 = vtk.vtkActor()
  aVertexActorPCA2.SetMapper(aVertexMapperPCA2)
  aVertexActorPCA2.GetProperty().SetDiffuseColor(0, 1, 1)
  ...
  ren.AddActor( aVertexActorPCA )
  ren.AddActor( aVertexActorPCA2 )
