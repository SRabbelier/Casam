...
SET(VTK_INCLUDE_DIRS "${VTK_INSTALL_PREFIX}/include/vtk-5.2;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/usr/include;/home/cpbotha/build/jwd/inst/python/include/python2.5")
...
SET(VTK_RUNTIME_LIBRARY_DIRS "${VTK_INSTALL_PREFIX}/lib/vtk-5.2")
...
SET(VTK_WRAP_HINTS "${VTK_INSTALL_PREFIX}/lib/vtk-5.2/hints")

# CMake extension module directory and macro file.
SET(VTK_LOAD_CMAKE_EXTENSIONS_MACRO "/home/cpbotha/build/jwd/archive/VTK/CMake/vtkLoadCMakeExtensions.cmake")
...
SET(VTK_KITS "COMMON;FILTERING;IO;GRAPHICS;GENERIC_FILTERING;IMAGING;RENDERING;VOLUMERENDERING;HYBRID;WIDGETS;PARALLEL;INFOVIS;VIEWS")
...
SET(VTK_PYTHONPATH_DIRS "${VTK_INSTALL_PREFIX}/lib/python2.5/site-packages;${VTK_INSTALL_PREFIX}/lib/python2.5/site-packages")
...
SET(VTK_PRT_IMAGE_TEST_TCL "${VTK_INSTALL_PREFIX}/lib/vtk-5.2/testing/prtImageTest.tcl")
